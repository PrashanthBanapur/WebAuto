...
public class ReportUtil {
	 ...
	 * @param msg2
	 */
	static void reportWebStep(WebElement element ,String desp , String msg1 , String msg2){
	 ...
	 * @return
	 */
	private static WebElement unhighlightElement(WebDriver driver , WebElement element , String border){
		if (driver instanceof JavascriptExecutor) {
			try {
